...
@section('content')
    <div id="user-profile-body" class="user-profile-body-wrapper mh-690 bg-content-grey">
        <div class="user-profile-wrapper bg-content-grey pt-4">
            <div class="account-main">
                ...
                <div class="email-pass-wrapper">
                    ...
                    <div class="email account-textbox mb-3">
                        ...
                        <div class="alert alert-danger" id="profileupdate-error-bag" style="display: none;">
                            <ul id="profileupdate-info-errors">
                            </ul>
                        </div>
                        <div class="input-changelink-wrapper">
                            <input class="email-update" type="text" id="email" placeholder="Email" name="email"
                                value="{{ $users['email'] }}">
                            <div class="change-link email-change-link updateUser" onclick="" id="email-change">Change</div>
                    ...
                    <div class="pwd account-textbox mt-25">
                        ...
                        <div class="input-changelink-wrapper">
                            <input class="password-update" type="password" id="pwd" name="pwd">
                            <div class="change-link password-change-link updateUser" id="pass-change">Change</div>
                        </div>

                    </div>
                    <div id="success_messageUpdateprofile">
            ...
            <div class="profile-payment-settings-main mt-25">
                <div class="profile-payment-tab">
                    ...
                    <div class="tab">
                        <div id="profileClick" class="profile-tab tablinks profile-payment-tablink profile-tab active"
                            onclick="openProfile('profile')">Profile</div>
                        <div id="paymentClick" class="payment-tab tablinks paymentmethod-tab profile-payment-tablink"
                            onclick="openProfile('paymentmethod')">Payment History</div>
                    </div>
                    ...
                    <div id="profile" class="tabcontent" style="display: block;">
                        <div class="profile-main mt-25">
                            ...
                            <div class="first_name profile-textbox">
                                ...
                                <input type="text" class="form-control firstname" id="first-name" placeholder="First Name"
                                    name="firstname"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['firstname'] : $users['first_name'] }}">
                            </div>
                            <div class="last_name profile-textbox">

                                <div class="last-name profilelabel requiredstar">Last Name</div>
                                <input type="text" class="form-control lastname" id="last-name" placeholder="Last Name"
                                    name="lastname" value="{{ $users['last_name'] }}">
                            </div>
                            <div class="company profile-textbox">
                                <div class="company profilelabel">Company</div>
                                <input type="text" class="form-control companyuser" id="company" placeholder="Company"
                                    name="company"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['company'] : '' }}">
                            </div>
                            <div class="company profile-textbox">
                                <div class="company profilelabel">Tax ID (mandatory if you plan to charge Sales Tax)</div>
                                <input type="text" class="form-control tax_id" id="tax_id" placeholder="Tax ID"
                                    name="tax_id"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['tax_id'] : '' }}">
                            </div>
                            <div class="title profile-textbox">
                                <div class="title profilelabel">Title</div>
                                <input type="text" class="form-control titlee" id="title" placeholder="Title" name="title"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['title'] : '' }}">
                            </div>
                            <div class="phone profile-textbox">
                                <div class="phone profilelabel requiredstar">Phone</div>
                                <input type="text" class="form-control phoneuser" id="phoneuser"
                                    placeholder="Phone E.g. 4161234567" name="phoneuser"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['phone'] : '' }}"
                                    maxlength="10">
                            </div>
                            <div class="address profile-textbox">
                                <div class="address profilelabel requiredstar">Address</div>
                                <input type="text" class="form-control addressuser" id="address" placeholder="Address"
                                    name="address"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['address'] : '' }}">
                            </div>
                            <div class="city profile-textbox">
                                <div class="city profilelabel requiredstar">City</div>
                                <input type="text" class="form-control cityuser" id="city" placeholder="City" name="city"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['city'] : '' }}">
                            </div>
                            <div class="province profile-textbox">
                                ...
                                <input class="form-control provincee" type="text" id="provincee" name="provincee"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['province'] : '' }}">
                                ...
                                <div class="postal_code profile-textbox">
                                    ...
                                    <input type="text" class="form-control postal_codee" id="postal_codee"
                                        placeholder="M1M1M1" name="postal_codee"
                                        value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['postal_code'] : '' }}">
                                </div>
                                <div class="country profile-textbox">
                                    ...
                                    <select class="form-control profile countryy" id="countryy" name="countryy">
                                        ...
                                        <option value="CA"
                                            {{ isset($user_detail['payment_country']) == 'CA' ? 'selected="selected"' : '' }}>
                                            Canada</option>
                                        <option value="US"
                                            {{ isset($user_detail['payment_country']) == 'US' ? 'selected="selected"' : '' }}>
                        ...
                        <div class="profile-payment-btn">
                            ...
                            <input type="hidden" class="form-control user_id" id="user_id" placeholder="user ID"
                                name="user_id" value="{{ $users['id'] }}">
                            <input type="hidden" class="form-control user_type" id="user_type" placeholder="user ID"
                                name="user_type" value="{{ $users['user_type'] }}">
                            <div id="success_message">


                            </div>
                            <button type="submit" class="btn btn-primary update_user"
                                id="btn-profile-payment-save">Save</button>
                        </div>
                    </div>
                    ...
                    <div id="paymentmethod" class="tabcontent" style="display: none ;">
                        {{-- <div class="payment-main  mt-25">
                            ...
                            <div class="payee payment-textbox">
                                ...
                                <input type="text" id="payee" class="form-control payeee"
                                    placeholder="Payee (Person or Business)" name="payee"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['payee'] : '' }}">
                            </div>
                            <div class="mailing-lbl payment-textbox pb-3">Mailing Address</div>

                            <div class="address-chk align-items-center">
                                <input class="profile-adrs" type="checkbox" checked="checked" id="profile-adrs"
                                    name="profile-adrs">
                            ...
                            <div class="payment-address payment-textbox">
                                ...
                                <input type="text" id="payment_address" class="form-control payment_address"
                                    placeholder="Address" name="payment_address"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['payment_address'] : '' }}">
                            </div>
                            <div class="payment-city payment-textbox">
                                <div class="form-controlpayment-city paymentlabel requiredstar">City</div>
                                <input type="text" id="payment_city" class="form-control payment_city" placeholder="City"
                                    name="payment_city"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['payment_city'] : '' }}">
                            </div>
                            <div class="payment-province profile-textbox">
                                <div class="payment-province paymentlabel requiredstar">Province/State</div>
                                <input type="hidden" id="payment-selected-province" name="payment-selected-province"
                                    value="ON">
                                <input type="hidden" id="payment-selected-country" name="payment-selected-country"
                                    value="CA">
                                ...
                                <select class="form-control profile payment_province" id="payment_province"
                                    name="payment_province">
                                </select>
                            </div>
                            <div class="payment-postal_code payment-textbox">
                                <div class="postal_code paymentlabel requiredstar">Postal Code or Zip Code</div>
                                <input type="text" id="payment_postal_code" class="form-control payment_postal_code"
                                    placeholder="M1M1M1" name="payment_postal_code"
                                    value="{{ $users['id'] == isset($user_detail['user_id']) ? $user_detail['payment_postal_code'] : '' }}">
                            </div>
                            <div class="payment-country profile-textbox">
                                <div class="country paymentlabel requiredstar">Country</div>
                                <select class="form-control profile payment_country" id="payment_country"
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 400) {
                            ...
                            $('#profile-info-errors').addClass("alert alert-danger px-5");
                            $.each(response.errors, function(key, err_values) {
                                $('#profile-info-errors').append('<li>' + err_values +
                                    '</li>');
                                $('#profile-error-bag').css('display', 'block');
                            ...
                            $('#profile-info-errors').html("");
                            $('#success_message').addClass('alert alert-success px-5');
